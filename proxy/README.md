...
그 외 경로·모델과 48KiB를 넘는 요청은 거절한다. 대화 토큰·메시지 길이, TTS 문자 수,
임베딩 묶음 크기도 Worker에서 다시 제한하므로 변조된 앱이 임의의 고비용 요청을 전달할 수 없다.
...
대화 30회/분, TTS·임베딩 20회/분, Realtime 토큰 10회/분이다. 이 카운터는 허용적인
