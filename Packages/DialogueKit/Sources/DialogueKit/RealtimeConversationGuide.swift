...
public struct RealtimeConversationGuide: Sendable {
    ...
    public static func openingInstructions(
        ...
        살짝 피곤한 태도로 말한 뒤 기다려라. 바쁘다거나 혼자라는 상황을 말했다면 그걸로
        충분하다 — 바로 뒤에 "필요하신 거 있으면 편하게/짧게/간단히 말씀하세요/말씀만
        하세요" 같은 손님 응대 멘트를 습관적으로 덧붙이지 마라. 정말 바빠서 정신없는
        사람은 그렇게 친절하게 초대하듯 말을 걸지 않는다 — 상황만 말하고 멈추거나,
