...
public struct PromptBuilder: Sendable {
    ...
    public func build(persona: NPCPersona, climate: SocialClimate,
                      ...
                      orderCollectionDecision: RainbowSmoothieOrderDecision = .continueConversation) -> [Message] {
        let system = """
        ...
        Every reply must contain at least two complete sentences. Normally use exactly two short sentences, never more than three, and stay under 35 Korean words. Keep only the conversational core and vary sentence rhythm naturally. \
        ...
        Sound like a real tired person, not a service chatbot: use contractions, mild hesitation, and context-specific wording when natural. Avoid scripted customer-service phrases, lectures, lists, stage directions, emotion labels, and repeatedly saying 고객님, 죄송하지만, or 도와드릴게요. \
